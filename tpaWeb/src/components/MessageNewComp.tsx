...
import { AddMessage, AddRoom, UserConnected } from '../queries/queryUser';

const MessageNewComp = ({ roomData, userBlockData, closeModal }: any) => {
            ...
            <div className="modal relative">
                ...
                <div>
                    <div>
                        ...
                        <textarea value={text} className="w-full mt-5 input-type" onChange={(e) => setText(e.target.value)} placeholder="Write a message..." style={{ resize: "none", height: "100px" }}></textarea>
                    </div>
                    <div className="w-full mt-2">
                        <div className="flex-row">
                            <div className="mr-2">
                                <label htmlFor="image-input" className="video">
                                    <AiFillPicture className='cursor-pointer' size={30}/>
                                </label>
                                <input type="file" onChange={(e) => changeImageHandler(e, "image")} id="image-input" style={{ display: "none"}} />
                            </div>
                        </div>
                        <div className='w-full flex-row'>
                            <button className="blue-button-xs" onClick={handleAddRoom}>
                                Send
                            </button>
