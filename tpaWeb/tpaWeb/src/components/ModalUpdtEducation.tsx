...
import { CreateEdu, UpdtEdu } from '../queries/queryUser'
import { BsEmojiDizzy } from 'react-icons/bs'


export default function ModalUpdtEducation(parameter: any) {
    ...
    const currID = parameter.education.ID
    const [ update ] = useMutation(UpdtEdu)
    ...
    return (
        <div className='modal center-all'>
            ...
            <div className='w-full flex-row space-evenly'>
                <button onClick={handleUpdateEdu} className='blue-button-s text-white'>Save</button>
