...
import { CreateExperience } from '../queries/queryUser'

export default function ModalExperience(parameter: any){
    const userContext = UserAuth()
    const [ createExp ] = useMutation(CreateExperience)
        ...
        <div className='modal center-all'>
            <div className='form'>
                ...
                <div className='w-full flex-row space-evenly'>
                    <button onClick={handleCreateExperience} className='blue-button-s text-white'>Save</button>
